...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        <div>
          <div className="mask-clip-path absolute bottom-10 right-10 z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
            <div
        ...
        <h1 className="special-font font-zentry hero-heading top-40 left-10 text-7xl md:text-9xl lg:text-[12rem] absolute z-40 text-blue75">
          G<b>A</b>MING
        </h1>

        <div className="absolute left-0 top-60 z-50 size-40">
      ...
      <h1 className="special-font font-zentry hero-heading mt-24 top-60 left-10 text-7xl md:text-9xl lg:text-[12rem] absolute text-black">
        VALORA<b>N</b>T
      </h1>
    </div>
  );
